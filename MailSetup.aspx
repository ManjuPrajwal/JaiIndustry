<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MailSetup.aspx.cs" Inherits="MailSetup" %>
 ...
 <div class="container set-pad">
      <div class="row text-center">
                 <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                     <h1 data-scroll-reveal="enter from the bottom after 0.1s" class="header-line" >MAIL SETUP </h1>
                 ...
                 <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
                    <form>
                     <div class="form-group">
                        ...
                        <div class="form-group">
                            <asp:TextBox ID="txtPassword" TextMode="Password" runat="server" class="form-control "  required="required" placeholder="Your Password" ></asp:TextBox>
                        ...
                        <div class="form-group">
                         <asp:Button ID="btnSave" runat="server" class="btn btn-info btn-block btn-lg" 
                                Text="SETUP MAIL" onclick="btnSave_Click" />
